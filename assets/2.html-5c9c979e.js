import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,f as l}from"./app-fc5d6b9f.js";const a={},d=l(`<h1 id="verson8-1-0-修饰器" tabindex="-1"><a class="header-anchor" href="#verson8-1-0-修饰器" aria-hidden="true">#</a> verson8.1.0+ 修饰器</h1><h2 id="observableproperty-修饰器-替代setproperty" tabindex="-1"><a class="header-anchor" href="#observableproperty-修饰器-替代setproperty" aria-hidden="true">#</a> [ObservableProperty] 修饰器(替代SetProperty)</h2><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>    partial class MainViewModel : ObservableObject
    {
        // 以下三种均可以转换为Title
        [ObservableProperty]
