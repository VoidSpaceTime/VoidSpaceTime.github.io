import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,f as l}from"./app-fc5d6b9f.js";const s="/assets/WPF&Prism/PrismTemplatePack.png",a={},r=l(`<h1 id="prism-环境配置" tabindex="-1"><a class="header-anchor" href="#prism-环境配置" aria-hidden="true">#</a> prism 环境配置</h1><h2 id="prism-安装" tabindex="-1"><a class="header-anchor" href="#prism-安装" aria-hidden="true">#</a> Prism 安装</h2><ol><li>新建一个wpf项目</li><li>NuGet 搜索安装 Prime.Dryloc</li><li>修改 App 文件的继承类</li></ol><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>/// &lt;summary&gt;
