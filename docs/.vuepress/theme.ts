...
export default hopeTheme({
  ...
  locales: {
    "/": {
      // 导航栏
      navbar: enNavbar, // 暂时不用英文
      // navbar: zhNavbar,

      // 侧边栏
      sidebar: enSidebar, 
      // sidebar: zhNavbar, // 暂时不用英文
  ...
  plugins: {
    ...
    // 启用评论插件
    // 注意：这是一个仅供演示的测试服务器。
    // 在生产环境中，你应该创建并使用自己的评论服务。
    // comment: {
    //   provider: "Waline",
    //   serverURL: "https://waline-comment.vuejs.press",
    // },

    // 启用所有功能以供演示，只在此处保留你需要的功能
    mdEnhance: {
      align: true,
      attrs: true,
